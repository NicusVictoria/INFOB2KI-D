    ...
    def trainAndTune(self, trainingData, trainingLabels, validationData, validationLabels, Cgrid):
        ...
        for i in range(len(trainingData)):
            ...
            if(best_label != true_label):
                ...
                wbl = self.weights[best_label]
                wtl = self.weights[true_label]
                ...
                tau = 0.5#((wbl-wtl)*data + 1)/(copy1 * copy2)
                ...
                copy = data.copy()
                copy.divideAll(1/tau)
                
                self.weights[best_label] -= copy
                self.weights[true_label] += copy
